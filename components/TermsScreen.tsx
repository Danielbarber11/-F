    ...
    <div className="min-h-screen w-full flex items-center justify-center animate-gradient p-4 relative">
      ...
      <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 w-full max-w-2xl fade-in-up border border-white/40">
        ...
        >
          ...
          <p className="font-bold mb-2">7. אחריות צד ג' (מודלים)</p>
          <p className="mb-4">
             השירות עושה שימוש במודלים של בינה מלאכותית המסופקים ע"י צדדים שלישיים (כגון Google, OpenAI). כל תקלה, שגיאה או נזק שייגרם כתוצאה משימוש במודלים אלו הינם באחריות החברות המספקות אותם (Google, OpenAI וכו') בלבד. המשתמש פוטר את מפעיל האתר מכל אחריות הקשורה לביצועי המודלים הללו.
          </p>
